...
void OverviewPage::setBalance(const interfaces::WalletBalances& balances)
{
    ...
    if (walletModel->wallet().isLegacy()) {
        if (walletModel->wallet().privateKeysDisabled()) {
            ...
            ui->labelStake->setText(BitcoinUnits::formatWithUnit(unit, balances.watch_only_stake, BitcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
            ...
            ui->labelStake->setText(BitcoinUnits::format(unit, balances.stake, BitcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
            ...
            ui->labelWatchStake->setText(BitcoinUnits::formatWithUnit(unit, balances.watch_only_stake, BitcoinUnits::SeparatorStyle::ALWAYS, m_privacy));

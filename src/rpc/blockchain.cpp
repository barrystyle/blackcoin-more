...
static std::vector<RPCResult> MempoolEntryDescription() { return {
    ...
    RPCResult{RPCResult::Type::STR_HEX, "txid", "hash of serialized transaction"},
                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of blackcoin addresses",
...
static UniValue getblockstats(const JSONRPCRequest& request)
{
    ...
    int64_t inputs = 0;
    int64_t maxtxsize = 0;
    int64_t mintxsize = Params().GetConsensus().MaxBlockSize(block.GetBlockTime());
    int64_t outputs = 0;
    ...
    ret_all.pushKV("avgfeerate", (total_size > 0) ? totalfee / total_size : 0); // Unit: sat/vbyte
    ...
    ret_all.pushKV("mintxsize", mintxsize == Params().GetConsensus().MaxBlockSize(block.GetBlockTime()) ? 0 : mintxsize);

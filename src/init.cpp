...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    // Blackcoin ToDo: remove blockmaxsize
    argsman.AddArg("-blockmaxsize=<n>", strprintf("Set maximum block size (default: %d)", DEFAULT_BLOCK_MAX_SIZE), ArgsManager::ALLOW_ANY, OptionsCategory::BLOCK_CREATION);

...
{
    gArgs.AddArg("-addresstype", strprintf("What type of addresses to use (\"legacy\" or \"bech32\", default: \"%s\")", FormatOutputType(DEFAULT_ADDRESS_TYPE)), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    ...
    gArgs.AddArg("-changetype", "What type of change to use (\"legacy\" or \"bech32\"). Default is same as -addresstype)", ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    ...
    gArgs.AddArg("-donatetodevfund=<n>", strprintf("Donate the specified percentage of staking rewards to the dev fund (default: %u)", DEFAULT_DONATION_PERCENTAGE), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);

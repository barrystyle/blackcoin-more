...
Below are some notes on how to build Blackcoin More for Windows.
...
Note that for WSL the Blackcoin More source path MUST be somewhere in the default mount file system, for
...
It's not possible to build the Blackcoin More code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the Blackcoin More source code).

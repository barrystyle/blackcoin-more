...
Optional dependencies:
 ...
 libdb6.2    | Berkeley DB      | Optional, wallet storage (only needed when wallet enabled)
...
Berkeley DB 5.1. This will break binary wallet compatibility with the distributed executables, which
